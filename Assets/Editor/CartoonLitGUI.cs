...
{
    [MovedFrom("UnityEditor.Rendering.LWRP.ShaderGUI")] public static class CartoonLitGUI
    {
        ...
        public struct CartonLitProperties
        {
            // Surface Input Props
            ...
            public CartonLitProperties(MaterialProperty[] properties)
            {
                // Surface Input Props
        ...
        public static void Inputs(CartonLitProperties properties, MaterialEditor materialEditor, Material material)
        {
            DoSpecularArea(properties, materialEditor, material);
            BaseShaderGUI.DrawNormalArea(materialEditor, properties.bumpMapProp);
        }

        public static void Advanced(CartonLitProperties properties)
        {
        ...
        public static void DoSpecularArea(CartonLitProperties properties, MaterialEditor materialEditor, Material material)
        {
        ...
        public static void DoSmoothness(CartonLitProperties properties, Material material)
        {
        ...
        {
            //CoreUtils.SetKeyword(material, "_CORE_SHADOWS", true);
